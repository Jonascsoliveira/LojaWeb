...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.jonasoliveira.lojaweb.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
			...
			"Esta API é resultado de estudos acompanhando o curso de SpringBoot",
			"Versão 1.0",
			"https://www.mock.com/terms",
			new Contact("Jonas Oliveira", "https://www.mock.com", "jonas.cursos.aprendizado@gmail.com"),
